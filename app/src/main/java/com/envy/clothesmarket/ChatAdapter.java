...
import com.envy.clothesmarket.databinding.RowChatBinding;
...
public class ChatAdapter extends RecyclerView.Adapter<ChatAdapter.MyViewHolder> {
    ...
    public ChatAdapter(List<ChatMessage> messageArrayList, Context context) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
            holder.getBinding().setVariable(BR.chatMessage,messageArrayList.get(position));
